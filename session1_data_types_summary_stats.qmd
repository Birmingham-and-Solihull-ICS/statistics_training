...
p <- p + geom_vline(aes(xintercept = 500), col = "red", linetype = 2, size = 1.2, alpha = 0.5) +
  geom_text(aes(x = 500, y = 0.0028, label = "mean"), col = "red", alpha = 0.5)
...
$$ sd = \sqrt{ \frac{\sum_{i=1}^n x_i \left(x_i - \bar{x}^2 \right)}{n-1}}  =   sqrt\left(\frac{sum((x_i-\bar{x})^2)}{n-1}\right)$$
```{r Norm3}
...
p <- p + geom_vline(aes(xintercept = 350), col = "goldenrod", linetype = 2, size = 1.2, alpha = 0.7) +
  ...
  geom_text(aes(x = 350, y = 0.0028, label = "mean-sd"), col = "goldenrod", alpha = 0.5) +
  geom_text(aes(x = 650, y = 0.0028, label = "mean+sd"), col = "goldenrod", alpha = 0.5) +
  theme()
...
p <- p + geom_segment(aes(x = 350, xend = 650, y = 0.002, yend = 0.002), size = 1,  
  ...
  geom_text(aes(x = 500, y = 0.00206, label = "68.27%"),  size = 4, col = "dodgerblue2")
p
```
...
#add two sd lines 
p <- p + geom_vline(aes(xintercept = 200), col = "palegreen4", linetype = 2, size = 1.2, alpha = 0.7) +
  geom_vline(aes(xintercept = 800), col = "palegreen4", linetype = 2, size = 1.2, alpha = 0.7)+
  geom_text(aes(x = 200, y = 0.0028, label = "mean-2*sd"), col = "palegreen4", alpha = 0.5)+
  geom_text(aes(x = 800, y = 0.0028, label = "mean+2*sd"), col = "palegreen4", alpha = 0.5)
...
# add 2 sd label
p <- p + geom_segment(aes(x = 200, xend = 800, y = 0.00125, yend = 0.00125),
  size = 1,
  arrow = arrow(ends = "both", type = "closed", length = unit(0.25, "cm")), col = "dodgerblue2"
) +
  geom_text(aes(x = 500, y = 0.00131, label = "95.45%"), size = 4, col = "dodgerblue2")
...
p <- p + geom_vline(aes(xintercept = 50), col = "chocolate4", linetype = 2, size = 1.2, alpha = 0.7) +
  ...
  geom_text(aes(x = 50, y = 0.0028, label = "mean-3*sd"), col = "chocolate4", alpha = 0.5) +
  geom_text(aes(x = 950, y = 0.0028, label = "mean+3*sd"), col = "chocolate4", alpha = 0.5)
...
p <- p + geom_segment(aes(x = 50, xend = 950, y = 0.0005, yend = 0.0005),
  ...
  geom_text(aes(x = 500, y = 0.00056, label = "99.73%"), size = 4, col = "dodgerblue2")
...
- 75th - 25th ntile referred to as ‘Inter-quartile range’ (IQR).

- Can also list extremes of distribution.

- Mean & SD not a good representation
